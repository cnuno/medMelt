...
/*
April 13: worked for 2 hours to implement a level select menu to the game. also added functionality to "B" button on menu screens"
   */
...
void render_pause(Game *game)
{
       ...
       glVertex3f(game->WINDOW_WIDTH - game->WINDOW_WIDTH/10, game->WINDOW_HEIGHT - 
       game->WINDOW_HEIGHT/10, 0.0);
       glVertex3f(game->WINDOW_WIDTH - game->WINDOW_WIDTH/10, game->WINDOW_HEIGHT/10, 0.0);
       glEnd();*/
